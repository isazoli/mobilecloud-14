...
public class Video {
	...
	private long likes;
	@ElementCollection
	private Set<String> usersWithLikes;
	...
	public Set<String> getUsersWithLikes() {
		return usersWithLikes;
	}

	public void setUsersWithLikes(Set<String> usersWithLikes) {
		this.usersWithLikes = usersWithLikes;
	}
